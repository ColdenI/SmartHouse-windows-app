...
namespace Smart_House
{
    public partial class SettingsForm : Form
    {
        ...
        private void SettingsForm_Load(object sender, EventArgs e)
        {
            ...
            checkBox_isMakeFile.Checked = Properties.Settings.Default.isMakeFile;
        }
        ...
        private void checkBox_isMakeFile_CheckedChanged(object sender, EventArgs e)
        {
            Properties.Settings.Default.isMakeFile = checkBox_isMakeFile.Checked;
            Properties.Settings.Default.Save();
        }
    }
}
